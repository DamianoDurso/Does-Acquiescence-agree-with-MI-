...
F1 =~ c(NA, NA)*V1 + c(lambda.1_1.g1, lambda.1_1.g2)*V1
...
F1 =~ c(NA, NA)*V1 + c(lambda.1_1, lambda.1_1)*V1
...
V1 ~ c(0, 0)*1 + c(nu.1, nu.1)*1
V2 ~ c(0, 0)*1 + c(nu.2, nu.2)*1
V3 ~ c(0, 0)*1 + c(nu.3, nu.3)*1
V4 ~ c(0, 0)*1 + c(nu.4, nu.4)*1
V5 ~ c(0, 0)*1 + c(nu.5, nu.5)*1
V6 ~ c(0, 0)*1 + c(nu.6, nu.6)*1
V7 ~ c(0, 0)*1 + c(nu.7, nu.7)*1
V8 ~ c(0, 0)*1 + c(nu.8, nu.8)*1
V9 ~ c(0, 0)*1 + c(nu.9, nu.9)*1
V10 ~ c(0, 0)*1 + c(nu.10, nu.10)*1
V11 ~ c(0, 0)*1 + c(nu.11, nu.11)*1
V12 ~ c(0, 0)*1 + c(nu.12, nu.12)*1
...
F1 ~ c(0, NA)*1 + c(alpha.1.g1, alpha.1.g2)*1
...
## COMMON-FACTOR VARIANCES:
F1 ~~ c(1, 1)*F1 + c(psi.1_1.g1, psi.1_1.g2)*F1
#ARS ~~ c(1, 1)*ARS + c(psi.2_2.g1, psi.2_2.g2)*ARS
...
## COMMON-FACTOR VARIANCES:
F1 ~~ c(1, NA)*F1 + c(psi.1_1.g1, psi.1_1.g2)*F1
#ARS ~~ c(1, NA)*ARS + c(psi.2_2.g1, psi.2_2.g2)*ARS
...
F1 ~ c(0, NA)*1 + c(alpha.1.g1, alpha.1.g2)*1
ARS ~ c(0, NA)*1 + c(alpha.2.g1, alpha.2.g2)*1
...
V1 ~ c(0, 0)*1 + c(nu.1, nu.1)*1
V3 ~ c(0, 0)*1 + c(nu.2, nu.2)*1
V5 ~ c(0, 0)*1 + c(nu.3, nu.3)*1
V7 ~ c(0, 0)*1 + c(nu.4, nu.4)*1
V9 ~ c(0, 0)*1 + c(nu.5, nu.5)*1
V11 ~ c(0, 0)*1 + c(nu.6, nu.6)*1
V13 ~ c(0, 0)*1 + c(nu.7, nu.7)*1
V15 ~ c(0, 0)*1 + c(nu.8, nu.8)*1
V17 ~ c(0, 0)*1 + c(nu.9, nu.9)*1
V19 ~ c(0, 0)*1 + c(nu.10, nu.10)*1
V21 ~ c(0, 0)*1 + c(nu.11, nu.11)*1
V23 ~ c(0, 0)*1 + c(nu.12, nu.12)*1
V2 ~ c(0, 0)*1 + c(nu.13, nu.13)*1
V4 ~ c(0, 0)*1 + c(nu.14, nu.14)*1
V6 ~ c(0, 0)*1 + c(nu.15, nu.15)*1
V8 ~ c(0, 0)*1 + c(nu.16, nu.16)*1
V10 ~ c(0, 0)*1 + c(nu.17, nu.17)*1
V12 ~ c(0, 0)*1 + c(nu.18, nu.18)*1
V14 ~ c(0, 0)*1 + c(nu.19, nu.19)*1
V16 ~ c(0, 0)*1 + c(nu.20, nu.20)*1
V18 ~ c(0, 0)*1 + c(nu.21, nu.21)*1
V20 ~ c(0, 0)*1 + c(nu.22, nu.22)*1
V22 ~ c(0, 0)*1 + c(nu.23, nu.23)*1
V24 ~ c(0, 0)*1 + c(nu.24, nu.24)*1
...
## LATENT MEANS/INTERCEPTS:
F1 ~ c(0, NA)*1 + c(alpha.1.g1, alpha.1.g2)*1
ARS ~ c(0, NA)*1 + c(alpha.3.g1, alpha.3.g2)*1
...
F2 =~ c(NA, NA)*V2 + c(lambda.7_2.g1, lambda.7_2.g2)*V2
...
## COMMON-FACTOR VARIANCES:
F1 ~~ c(1, 1)*F1 + c(psi.1_1.g1, psi.1_1.g2)*F1
F2 ~~ c(1, 1)*F2 + c(psi.2_2.g1, psi.2_2.g2)*F2
...
F2 =~ c(NA, NA)*V2 + c(lambda.7_2, lambda.7_2)*V2
...
F1 ~ c(0, NA)*1 + c(alpha.1.g1, alpha.1.g2)*1
F2 ~ c(0, NA)*1 + c(alpha.2.g1, alpha.2.g2)*1
...
F1 ~~ c(1, 1)*F1 + c(psi.1_1.g1, psi.1_1.g2)*F1
F2 ~~ c(1, 1)*F2 + c(psi.2_2.g1, psi.2_2.g2)*F2
#ARS ~~ c(1, 1)*ARS + c(psi.3_3.g1, psi.3_3.g2)*ARS
...
F1 ~~ c(1, NA)*F1 + c(psi.1_1.g1, psi.1_1.g2)*F1
F2 ~~ c(1, NA)*F2 + c(psi.2_2.g1, psi.2_2.g2)*F2
#ARS ~~ c(1, NA)*ARS + c(psi.3_3.g1, psi.3_3.g2)*ARS
...
F2 =~ c(NA, NA)*V2 + c(lambda.13_2.g1, lambda.13_2.g2)*V2
...
F2 =~ c(NA, NA)*V2 + c(lambda.13_2, lambda.13_2)*V2
...
'
  ...
  results[[4]] <- IntModnoARS
  results[[5]] <- ConfModARS
  results[[6]] <- ThrModARS
  results[[7]] <- LoadModARS
  results[[8]] <- IntModARS
  
  
  names(results) <- c("ConfModnoARS", "ThrModnoARS", "LoadModnoARS", "IntModnoARS",
                      "ConfModARS", "ThrModARS", "LoadModARS", "IntModARS")      
  return(results)
}
...
Estimate.MI.Models.ARS <- function(Data, Models){
  ...
  #Thresholds, loadings and intercepts invariant (prop. 7 Wu and Estabrook, 2016)    
  
  fit.int <-  myTryCatch(cfa(as.character(Models$IntModnoARS), 
                              data = Data, 
                              group = "group", 
                              ordered = colnames(Data[,-c(dim(Data)[2])]),
                              estimator = "WLSMV")  )
  
  fit.intARS <-  myTryCatch(cfa(as.character(Models$IntModARS), 
                                 data = Data, 
                                 group = "group", 
                                 ordered = colnames(Data[,-c(dim(Data)[2])]),
                                 estimator = "WLSMV")  )
  ...
  Models[[3]] <- fit.load
  Models[[4]] <- fit.int
  Models[[5]] <- fit.confARS
  Models[[6]] <- fit.thrARS
  Models[[7]] <- fit.loadARS
  Models[[8]] <- fit.intARS
  
  names(Models) <- c('Mod.Conf', 'Mod.Thr', 'Mod.Load', "Mod.Int", 
                     'Mod.ConfARS', 'Mod.ThrARS', 'Mod.LoadARS', 'Mod.IntARS')
  ...
  for(i in 1:length(Models)){
    if(is.na(Models[[i]]$value@Fit@se[2]) ){
      Results.alpha[[i]] <- Models[[i]]$warning
    } else {
      Results.alpha[[i]] <- list(lavInspect(Models[[i]]$value, 'std')$`1`$alpha, lavInspect(Models[[i]]$value, 'std')$`2`$alpha)
    }
  }
...
#  } else {
    Comparative.fit[[1]] <- c( myTryCatch(lavTestLRT(Models$Mod.Conf$value, Models$Mod.Thr$value, Models$Mod.Load$value, Models$Mod.Int$value)), 
                              ...
                              myTryCatch(Results.fit$Int.fit[c("rmsea.scaled", "cfi.scaled")] - Results.fit$Load.fit[c("rmsea.scaled", "cfi.scaled")]))
#  }
...
#    Comparative.fit[[2]] <- Models$Mod.ConfARS$warning
 # } else {
    Comparative.fit[[2]] <- c(myTryCatch(lavTestLRT(Models$Mod.ConfARS$value, Models$Mod.ThrARS$value, Models$Mod.LoadARS$value, Models$Mod.IntARS$value)), 
                              ...
                              myTryCatch(Results.fit$Int.fitARS[c("rmsea.scaled", "cfi.scaled")] - Results.fit$Load.fitARS[c("rmsea.scaled", "cfi.scaled")]))
#  }
